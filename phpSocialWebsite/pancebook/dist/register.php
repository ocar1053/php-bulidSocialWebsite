        ...
        <div class="grid">
            ...
            <form action="includes/register_inc.php" method="POST" class="form login">
                ...
                <div class="form__field">
                    ...
                    <input id="login__date" type="date" name="birthday" class="form__input" placeholder="birthday" style="background-color: #3b4148;" required>
                </div>
                <div class="form__field">
                    <label for="login__name"><svg class="icon">
                            <use xlink:href=""></use>
                        </svg><span class="hidden">Username</span></label>
                    <input id="login__number" type="number" name="age" class="form__input" placeholder="     age" oninput="value=value.replace(/[^\d]/g,'')" style="background-color: #3b4148;" required>
                </div>
                <div class="form__field">
